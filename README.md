...
启动成功后访问 `http://127.0.0.1:5173`。进程号写入 `.run/`，日志分别位于 `backend/.uvicorn.log`、`backend/.worker.log`、`backend/.scheduler.log`、`backend/.tradingagents-worker.log` 和 `frontend/.vite.log`。
